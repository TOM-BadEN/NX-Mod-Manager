...
[![platform](https://img.shields.io/badge/bilibili-教程-FB7299?logo=bilibili&logoColor=FFFFFF)](https://space.bilibili.com/411741167)
...
> [!WARNING]
> &emsp;&emsp;暂不支持怪物猎人的序列号适配，下一个版本将会实现该功能。
...
&emsp;&emsp;请[点击此处](https://github.com/TOM-BadEN/NX-Mod-Manager/releases/latest)下载最新的 nro 文件，并将其安装至 SD 卡中。软件的具体使用方法请[点击此处](https://space.bilibili.com/411741167)查看视频教程，或在应用内通过"关于软件"查看基础教程。

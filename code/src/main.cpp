...
int main(int argc, char* argv[]) {
    ...
    brls::Application::registerXMLView("SkeletonView", SkeletonView::create);
    ...
    brls::Application::registerXMLView("ScrollHint", ScrollHint::create);
    brls::Application::registerXMLView("SectionTitle", SectionTitle::create);
    brls::Application::registerXMLView("GradientBox", GradientBox::create);
    ...
    brls::Application::registerXMLView("CapsuleHints", CapsuleHints::create);

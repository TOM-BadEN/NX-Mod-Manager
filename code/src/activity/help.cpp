...
void Help::showEntry(size_t index) {
    ...
    for (auto& text : entry.texts) {
        ...
        if (!text.title.empty()) {
            ...
            m_container->addView(titleLabel);
        }
        ...
        if (!text.content.empty()) {
            ...
            m_container->addView(contentLabel);
        }
    }
...
void Help::buildEntries() {
    ...
    ac.addQr("wxp://f2f0mMaZS-xnKyAZaTyn813TQRZHTRKPzI6UWxldiWDYemRIq8Stt_LPfd1sLyV4v1jR", brls::getStr("help/qrWechat"));
    ac.addQr("https://qr.alipay.com/fkx14502q4ewflegde4xmd9", brls::getStr("help/qrAlipay"));
    ac.addQr("https://www.paypal.com/qrcodes/p2pqrc/7CQ7FTPN26AJ8", brls::getStr("help/qrPaypal"));
    ...
    ad.addQr("https://github.com/TOM-BadEN/NX-Mod-Manager", brls::getStr("help/qrGithub"));
    ad.addQr("https://qm.qq.com/cgi-bin/qm/qr?k=PrrCMC64n5PkJVchBhIxPWeRPq4UT3Rx&jump_from=webapi&authKey=wnTddnj5O40A2ktYbCPuiyuJt0715BsKcfGYbr/B0IFGrAqbwToVgA4GLY+ucd6g", brls::getStr("help/qrQQ"));
    ad.addQr("https://discord.gg/hPymY4XpAX", brls::getStr("help/qrDiscord"));
    ...
    b.addText(brls::getStr("help/guideAddMod"), brls::getStr("help/guideAddModDesc"));
    b.addText(brls::getStr("help/guideInstall"), brls::getStr("help/guideInstallDesc"));
    b.addText(brls::getStr("help/guideOnline"), brls::getStr("help/guideOnlineDesc"));
    b.addQr("https://www.bilibili.com/video/placeholder", brls::getStr("help/qrBilibili"));
    b.addQr("https://github.com/TOM-BadEN/NX-Mod-Manager", brls::getStr("help/qrGithub"));

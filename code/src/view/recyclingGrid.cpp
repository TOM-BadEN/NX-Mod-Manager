...
RecyclingGrid::RecyclingGrid() {
    ...
    registerAction(brls::getStr("views/recyclingGrid/pageUp"), brls::ControllerButton::BUTTON_LB, [this](...) { flipScreen(-1); return true; }, true, true);
    registerAction(brls::getStr("views/recyclingGrid/pageDown"), brls::ControllerButton::BUTTON_RB, [this](...) { flipScreen(1); return true; }, true, true);
}

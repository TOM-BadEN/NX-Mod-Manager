...
StoreGameList::StoreGameList(GameManager& gameManager)
    ...
    ShellState::setTitle(brls::getStr("page/storeGameList/frameTitle"));
}
...
void StoreGameList::setupGrid() {
    ...
    m_grid->setFocusChangeCallback([this](size_t index) {
        ...
        ShellState::setSubtitle(m_manager.storeGameList()[index].gameTid);
    });
}
...
void StoreGameList::setupFilterMenu() {
    m_filterMenu.title = brls::getStr("page/storeGameList/filterTitle");
    ...
    addFilterItem("page/storeGameList/filterAll", "page/storeGameList/filterAllDesc", GameFilterMode::All);
    addFilterItem("page/storeGameList/filterInstalled", "page/storeGameList/filterInstalledDesc", GameFilterMode::Installed);
    addFilterItem("page/storeGameList/filterNotInstalled", "page/storeGameList/filterNotInstalledDesc", GameFilterMode::NotInstalled);
...
void StoreGameList::reloadData() {
    ...
    // 更新标题
    ShellState::setTitle(m_keyword.empty() ? brls::getStr("page/storeGameList/titleDefault") : brls::getStr("page/storeGameList/titleSearch", m_keyword));
    ShellState::setSubtitle("");
...
void StoreGameList::showPlaceholders() {
    ...
    for (int i = 0; i < 15; i++) {
        ...
        game.gameName = brls::getStr("page/storeGameList/placeholderTitle");
        game.gameTid = "";
        game.lastUpdate = "...";
        game.iconId = -1;
        game.modCount = 0;
    ...
    m_emptyHint->setVisibility(brls::Visibility::GONE);
    ShellState::setIndexText(brls::getStr("page/storeGameList/placeholderIndex"));
    ShellState::setSubtitle("");
...
void StoreGameList::onPageLoaded(api::game::GameListResult result) {
    ...
    if (m_placeholderMode) {
        m_grid->setDataSource(new StoreGameListDS(m_manager.storeGameList(), [this](size_t index) {
            ...
            Page::pushPage(new StoreModList(game.gameTid, game.gameName, m_gameManager, nullptr, version));
        }));
        m_placeholderMode = false;
        m_grid->setInteractionLocked(false);
        setActionAvailable(brls::BUTTON_BACK, true);

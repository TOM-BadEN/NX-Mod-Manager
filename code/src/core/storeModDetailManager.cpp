...
StoreModDetailManager::Screenshots&
StoreModDetailManager::getScreenshots() {
...
ModInfo StoreModDetailManager::createDownloadedMod(const std::string& gameDir, std::string modDirName, const std::string& tempZipPath) {
...
std::vector<api::comment::Comment>&
StoreModDetailManager::getComments() {
    return m_comments;
}

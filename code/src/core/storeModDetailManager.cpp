...
StoreModDetailManager::StoreModDetailManager(int modId, std::string gameTid, bool downloaded)
    : m_modId(modId), m_gameTid(std::move(gameTid)), m_downloaded(downloaded) {}
...
void StoreModDetailManager::setDetail(api::mod::ModDetail detail) {
    detail.downloaded = m_downloaded;

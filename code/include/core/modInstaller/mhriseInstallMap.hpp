...
struct MHRisePakMapping {
    std::string modDirName; // MOD 目录名
    std::string sourcePak;  // 源 pak 文件名
    std::string targetPak;  // 实际安装后的目标 pak 文件名
};
...
public:
     ...
     * @param modDirName MOD 目录名
     * @param sourcePak 源 pak 文件名
     * @return 实际安装后的目标 pak 文件名
     */

...
namespace config {
    ...
    constexpr const char* defaultGameIconResource = "img/game/defaultIconUp.jpg";
    constexpr const char* virtualGameIconResource = "img/game/addGame.png";
    constexpr const char* virtualGameIconKey      = "@res/img/game/addGame.png";

...
public:
     ...
     */
    StoreModList(std::string gameTid, std::string gameName, GameManager& gameManager, ModManager* localModManager = nullptr);
    ~StoreModList();
...
private:
    ...
    util::AsyncFurture<void> m_versionTask;             // 异步版本列表加载任务

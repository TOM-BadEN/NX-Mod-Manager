...
public:
     ...
     */
    StoreModDetail(int modId, std::string gameTid, std::string gameName, GameManager& gameManager, ReturnCallback onReturn = nullptr, ModManager* localModManager = nullptr, std::string gameVersion = "...", bool downloaded = false);
    ~StoreModDetail();

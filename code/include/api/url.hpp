...
namespace game {
    ...
    inline std::string iconMirror(const std::string& tid) { return base; }
...
namespace mod {
    ...
    inline std::string checkUpdates(const std::string& gameTid) { return base; }
    ...
    inline std::string screenshotMirror(const std::string& gameTid, int modId, int index) { return base; }

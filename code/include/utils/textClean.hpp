...
namespace {
    ...
    /**
     * @brief 在排序映射表中查找 codepoint
     * @param cp 待查找的 codepoint
     * @return 命中时返回映射字符串指针，否则返回 nullptr
     */
    ...
    /**
     * @brief 判断字符是否为文件系统禁用字符
     * @param c 待判断的 codepoint
     * @return 是禁用字符时返回 true，否则返回 false
     */

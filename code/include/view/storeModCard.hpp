...
private:
    ...
    BRLS_BIND(SVGImage, m_installedIcon, "storeModCard/installedIcon");
    BRLS_BIND(CapsuleBadge, m_tagType, "storeModCard/tagType");
    BRLS_BIND(CapsuleBadge, m_tagGameVersion, "storeModCard/tagGameVersion");
    BRLS_BIND(SVGImage, m_iconLike, "storeModCard/iconLike");
    BRLS_BIND(SVGImage, m_iconDislike, "storeModCard/iconDislike");
    BRLS_BIND(SVGImage, m_iconDownload, "storeModCard/iconDownload");
    BRLS_BIND(SVGImage, m_iconTime, "storeModCard/iconTime");
